...
// Pure domain and data logic. No Swing UI classes.
public class VinylDomain {
    ...
    public static class Song {
        ...
        public String coverPath; // may be null
        transient ImageIcon coverIcon; // cached scaled icon

        public Song() {}
        public Song(int id, String title, String artist, String album, String genre, int bpm, int lengthSeconds, boolean explicit, int rating, String coverPath) {
            this.id = id;
            this.title = title;
            this.artist = artist;
            this.album = album;
    ...
    // ---------- Table model ----------
    public static class SongTableModel extends javax.swing.table.AbstractTableModel {
